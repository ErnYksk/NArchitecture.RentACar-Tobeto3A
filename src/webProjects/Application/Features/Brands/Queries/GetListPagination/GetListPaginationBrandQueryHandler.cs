...
public class GetListPaginationBrandQueryHandler : IRequestHandler<GetListPaginationBrandQuery, CarListModel>
{
    ...
    public async Task<CarListModel> Handle(GetListPaginationBrandQuery request, CancellationToken cancellationToken)
    {
